    ...
    protected function renderHeaderCellContent() {
        if ($this->grid->enableSorting && $this->sortable && $this->name !== null) {
            ...
            if ($sort->getDirection($this->name) === CSort::SORT_ASC) {
                $tootltip = "$label Sort by DESC";
            } else {
                $tootltip = "$label Sort by ASC";
            }
...
//            }
            ...
            echo $sort->link($this->name, $label, array('class' => 'sort-link', 'data-toggle' => 'tooltip', 'data-original-title' => $tootltip));
        } else {
