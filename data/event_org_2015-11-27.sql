...
insert  into `evt_event`(`event_id`,`event_name`,`event_date`,`status`,`created_at`,`created_by`,`modified_at`,`modified_by`) values (10,'John marraige2','2015-09-18','1','2015-09-09 12:01:52',1,'2015-09-09 12:02:42',1),(11,'Abe Marraige','2015-09-12','1','2015-09-09 13:20:27',1,'0000-00-00 00:00:00',NULL),(14,'Jhon Weeding','2015-12-01','1','2015-10-05 03:36:56',1,'0000-00-00 00:00:00',NULL),(15,'Rajendran','2015-10-06','1','2015-10-05 04:22:35',1,'0000-00-00 00:00:00',NULL),(16,'Udhya Wedding','2016-01-08','1','2015-10-13 01:07:27',1,'0000-00-00 00:00:00',NULL),(17,'Harry\' wedding','2015-10-31','1','2015-10-13 01:31:38',1,'0000-00-00 00:00:00',NULL),(18,'Vcreators','2015-10-21','1','2015-10-20 19:25:18',1,'0000-00-00 00:00:00',NULL),(19,'Dummy Event','2015-11-30','1','2015-11-27 15:35:03',3,'0000-00-00 00:00:00',NULL);
...
CREATE TABLE `evt_event_lists` (
  ...
  KEY `FK_evt_event_lists_role` (`list_role`),
  CONSTRAINT `FK_evt_event_lists_role` FOREIGN KEY (`list_role`) REFERENCES `evt_role` (`role_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
insert  into `evt_event_lists`(`timing_id`,`event_id`,`list_title`,`list_role`,`timing_start`,`timing_notes`,`event_type`,`event_adjusted`,`created_at`,`created_by`,`modified_at`,`modified_by`) values (28,10,'Makeup23232',2,'14:00:00','sdsds\nsds\nd','FL','Y','2015-09-09 12:01:52',1,'2015-09-09 19:15:05',2),(29,10,'Decoration',2,'10:50:00','XXXXXXX','FL','Y','2015-09-09 12:01:52',1,'2015-09-09 19:15:17',2),(30,10,'Others',1,'12:00:00','dsadsad','FX','N','2015-09-09 12:01:52',1,'2015-09-09 12:02:42',1),(31,10,'Travelling to groom photoshoot',2,'13:00:00','asasas','FX','N','2015-09-09 12:02:42',1,'0000-00-00 00:00:00',NULL),(32,11,'Stage decoration',3,'10:00:00','Test test test','FL','N','2015-09-09 13:20:27',1,'0000-00-00 00:00:00',NULL),(33,11,'Travelling to groom photoshoot',4,'02:30:00','hhhh','FL','N','2015-09-09 13:20:27',1,'0000-00-00 00:00:00',NULL),(34,10,'sdsadsad',4,'12:05:00',NULL,'FL','N','2015-09-17 17:04:35',1,'0000-00-00 00:00:00',NULL),(35,14,'Marriage Function',6,'10:00:00',NULL,'FL','N','2015-10-05 03:39:25',1,'0000-00-00 00:00:00',NULL),(36,14,'Mehndi Functions',1,'16:00:00',NULL,'FL','N','2015-10-05 03:40:47',1,'0000-00-00 00:00:00',NULL),(37,11,'Camera Event',3,'16:40:00',NULL,'FL','N','2015-10-05 04:14:46',1,'0000-00-00 00:00:00',NULL),(38,15,'Event1',3,'10:00:00',NULL,'FL','N','2015-10-05 04:23:46',1,'0000-00-00 00:00:00',NULL),(39,15,'Event 2',2,'11:00:00',NULL,'FL','N','2015-10-05 04:24:07',1,'0000-00-00 00:00:00',NULL),(40,16,'Bridal',2,'09:35:00',NULL,'FL','N','2015-10-13 01:07:57',1,'0000-00-00 00:00:00',NULL),(41,16,'Groom Mackup',3,'10:30:00',NULL,'FL','N','2015-10-13 01:08:19',1,'0000-00-00 00:00:00',NULL),(42,16,'Wedding',4,'11:35:00',NULL,'FL','N','2015-10-13 01:08:32',1,'0000-00-00 00:00:00',NULL),(43,16,'Groom',3,'09:55:00',NULL,'FL','N','2015-10-13 01:09:58',1,'0000-00-00 00:00:00',NULL),(44,17,'bridal make up',7,'09:30:00','delay','FL','N','2015-10-13 01:32:15',1,'0000-00-00 00:00:00',NULL),(45,17,'bridal make up',3,'21:00:00',NULL,'FL','N','2015-10-13 01:32:32',1,'0000-00-00 00:00:00',NULL),(46,17,'bridal make up',4,'09:30:00','delay','FL','N','2015-10-13 01:36:46',1,'0000-00-00 00:00:00',NULL),(47,17,'bridal make up',3,'09:00:00',NULL,'FL','N','2015-10-13 01:47:54',1,'0000-00-00 00:00:00',NULL),(48,18,'event1',2,'08:10:00',NULL,'FL','N','2015-10-20 19:25:45',1,'0000-00-00 00:00:00',NULL),(49,18,'event5',3,'22:00:00',NULL,'FL','N','2015-10-20 19:26:04',1,'0000-00-00 00:00:00',NULL),(50,18,'event2',4,'11:00:00',NULL,'FL','N','2015-10-20 19:26:38',1,'0000-00-00 00:00:00',NULL),(51,18,'event3',6,'12:00:00',NULL,'FX','N','2015-10-20 19:28:26',1,'0000-00-00 00:00:00',NULL),(52,18,'event4',7,'15:00:00',NULL,'FL','N','2015-10-20 19:29:14',1,'0000-00-00 00:00:00',NULL);

/*Table structure for table `evt_event_vendors` */

CREATE TABLE `evt_event_vendors` (
  `evt_vendor` int(11) NOT NULL AUTO_INCREMENT,
  `evt_event_id` int(11) NOT NULL,
  `evt_user_id` int(11) NOT NULL,
  `is_status` enum('1','0') NOT NULL DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_by` int(11) NOT NULL,
  PRIMARY KEY (`evt_vendor`),
  KEY `FK_evt_event_vendors_user` (`evt_user_id`),
  KEY `FK_evt_event_vendors_event` (`evt_event_id`),
  CONSTRAINT `FK_evt_event_vendors_event` FOREIGN KEY (`evt_event_id`) REFERENCES `evt_event` (`event_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_evt_event_vendors_user` FOREIGN KEY (`evt_user_id`) REFERENCES `evt_user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=latin1;

/*Data for the table `evt_event_vendors` */

insert  into `evt_event_vendors`(`evt_vendor`,`evt_event_id`,`evt_user_id`,`is_status`,`created_at`,`created_by`) values (15,11,3,'1','2015-11-24 15:23:26',1),(16,10,4,'1','2015-11-24 15:23:24',1),(17,10,3,'1','2015-11-24 13:46:08',1),(18,18,3,'1','2015-11-24 15:41:53',1);
