...
CREATE TABLE `tbl_expense` (
  ...
  `exp_pay_mode` varchar(50) DEFAULT NULL,
  `exp_ref_no` varchar(50) DEFAULT NULL,
  `exp_bank_name` varchar(50) DEFAULT NULL,
  `exp_transaction_id` varchar(50) DEFAULT NULL,
  `exp_remarks` text,
  `exp_paid_amount` decimal(10,2) DEFAULT NULL,
...
insert  into `tbl_expense_subtype`(`exp_subtype_id`,`exp_subtype_name`,`status`,`created_at`,`created_by`,`modified_at`,`modified_by`) values (2,'Sub type 1','1','2015-09-16 17:27:28',NULL,'0000-00-00 00:00:00',NULL);
...
insert  into `tbl_expense_type`(`exp_type_id`,`exp_type_name`,`status`,`created_at`,`created_by`,`modified_at`,`modified_by`) values (2,'Expense type 1','1','2015-09-16 17:27:35',NULL,'0000-00-00 00:00:00',NULL);
