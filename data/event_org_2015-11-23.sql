...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`event_org` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `evt_deviceinfos`(`info_id`,`device_token`,`user_id`,`created_date`) values (2,'15451155',3,'2015-10-23 17:39:05');
